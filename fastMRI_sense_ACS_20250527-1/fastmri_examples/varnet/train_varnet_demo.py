...
from fastmrisense.data.mri_data import fetch_dir
from fastmrisense.data.subsample import create_mask_for_mask_type
from fastmrisense.data.transforms import VarNetDataTransform
from fastmrisense.pl_modules import FastMriDataModule, VarNetModule
add_safe_globals([pathlib.PosixPath])

def cli_main(args):
    pl.seed_everything(args.seed)
    print("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBB",args.num_workers)
...
def build_args():
    ...
    if args.resume_from_checkpoint is None:
        ...
        if ckpt_list:
            ...
            print(f"自动加载最新权重: {args.resume_from_checkpoint}")
        else:
            print("未找到历史权重，开始新训练")
